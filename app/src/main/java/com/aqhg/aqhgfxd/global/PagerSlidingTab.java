...
public class PagerSlidingTab extends HorizontalScrollView {
	...
	private int indicatorColor = 0xDDCC3333;//指示线的颜色#006BCE
	private int underlineColor = 0x1A000000;//指示器下面一条分割线的颜色
	private int dividerColor = 0x1A000000;// 指示器各个标签分割的分割线颜色
	...
	private int tabBackgroundResId = R.drawable.background_tab;  //指示器按下的颜色
